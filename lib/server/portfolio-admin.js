...
LIMIT 1`
  ...
  if (targetType === "static-manifest-role") {
    const roleId = cleanRequiredText(targetId, "角色不存在。");
    return updateVisibilityByColumn(env, "portfolio_static_images", "static_role_id", roleId, hiddenValue);
  }
